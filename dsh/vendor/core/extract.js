...
// ── SPA 空壳检测 ──
export const SPA_HINTS = [/id=["'](root|app|__nuxt|__next|__app)["']/i, /createRoot\(/i, /ReactDOM\.render/i, /data-server-rendered/i];

/** 正文过短 + root/app 特征 → 疑似 SPA/JS 渲染页面。 */
export function detectSpa(html, extractedText, visibleChars) {
